...
@Singleton
open class WordInfoUseCase @Inject constructor(private val repository: WordInfoRepository) {
    open operator fun invoke(word:String):Flow<Resource<List<WordInfo>>>{
        if(word.isBlank()){
            return flow {  }
        }
